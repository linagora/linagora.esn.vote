...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'frontend/app/vote.app.js',
      'frontend/app/**/*.js',
      'frontend/app/**/*.jade'
    ],
    exclude: ['frontend/app/vote.app.run.js'],
    frameworks: ['mocha'],
    colors: true,
    singleRun: true,
    autoWatch: true,
    ...
    ngJade2ModulePreprocessor: {
      ...
      cacheIdFromPath: function(filepath) {
        var cacheId = filepath.replace(/jade$/, 'html').replace(/^frontend/, '/vote');

return cacheId;
      },
      prependPrefix: '/linagora.esn.vote',
